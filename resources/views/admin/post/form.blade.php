<div class="row padding-1 p-1">
    <div class="col-md-12">
        ...
        <div class="form-group mb-2 mb20">
            ...
            <textarea name="content" class="form-control @error('content') is-invalid @enderror tinyMce" id="content" rows="3" placeholder="Contingut">{{ old('content', $post['content'] ?? '') }}</textarea>
