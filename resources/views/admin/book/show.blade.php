        ...
        <div class="book">
            ...
            <div class="book-detail flex justify-between mb-4">
                ...
                <div class="details flex flex-col space-y-3 justify-between h-auto">
                    ...
                    <div class="space-y-4">
                        <div class="sample flex space-x-2.5">
                        ...
                        <div class="add-to-cart">
                            <form action="{{ route('cart.insert') }}" method="POST">
                                ...
                                <input type="number" class="border border-black mb-2" name="number_of_items"
                                    placeholder="1" value="1" min="1">
                                <button type="submit" class="py-2.5 px-3 flex space-x-2 items-center" disabled>
                                    <span
            ...
            <div>
                ...
                @else
                    <div>
                        ...
                        <br>
                        <small>{{ __('general.You can find it in') }} {{ __('orthographicRules.les') }} <div
